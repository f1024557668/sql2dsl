...
import com.wantest.es.sql2dsl.es4sql.domain.Field;
import com.wantest.es.sql2dsl.es4sql.domain.KVValue;
import com.wantest.es.sql2dsl.es4sql.exception.SqlParseException;
import com.wantest.es.sql2dsl.es4sql.parse.ChildrenType;
...
public class AggMaker {
     ...
     */
    public AggregationBuilder makeGroupAgg(Field field, boolean isExact) throws SqlParseException {
        ...
        if (field instanceof MethodField) {
            ...
            if (methodField.getName().equals("filter")) {
                ...
                return AggregationBuilders.filter(paramsAsMap.get("alias").toString(),
                        QueryMaker.explan(where, isExact));
            }
